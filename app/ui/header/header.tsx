        ...
        <div className='flex md:order-2'>
          ...
          {isButtonVisible && (
            <button
              ...
              type='button'
              className='md: text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 rounded-lg text-sm p-2 inline-flex items-center dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600'
